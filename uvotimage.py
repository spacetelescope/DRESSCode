...
i = 0
num = sum(1 for filename in sorted(os.listdir(path)) if filename.endswith("rw.img") or filename.endswith(".evt"))
error = False
...
for filename in sorted(os.listdir(path)):
    ...
    #Print user information.
    i += 1
    print("Sky image created for all (other) frames of " + filename + " (" + str(i) + "/" + str(num) + ")")
